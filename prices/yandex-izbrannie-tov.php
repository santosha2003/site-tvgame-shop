...
// список предложений
          $res = $db -> query("SELECT id,name,model,vendor,price,photo_small,description FROM items WHERE cid='$cat[id]' AND status='Y' AND market_show='Y' AND shops LIKE '%|$shop_true_id|%'");
          if($res -> numRows()) {
