...
//	website : www.pengz.com
	...
	var scrollLeftMessage = "Нажмите, что бы увидеть предыдущий месяц. Оставляейте кнопку мышки нажатой для автоматического скролинга."
	var scrollRightMessage = "Нажмите, что бы увидеть следующий месяц. Оставляейте кнопку мышки нажатой для автоматического скролинга."
	var selectMonthMessage = "Нажмите, что бы выбрать месяц."
	var selectYearMessage = "Нажмите, что бы выбрать год."
	var selectDateMessage = "Выбрано [date]" // do not replace [date], it will be replaced by date.
