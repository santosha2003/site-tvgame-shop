...
// íîìåð çàêàçà // ÎÏÍÅÒ ÚÁËÁÚÁ
  $zid = $db -> nextId('orders');
  $missing = array();

// ñîõðàíåíèå äàííûõ î çàêàçàíûõ ïðîäóêòàõ // ÓÏÈÒÁÎÅÎÉÅ ÄÁÎÎÙÈ Ï ÚÁËÁÚÁÎÙÈ ÐÒÏÄÕËÔÁÈ
...
// ñîõðàíåíèå äàííûõ î çàêàçå // ÓÏÈÒÁÎÅÎÉÅ ÄÁÎÎÙÈ Ï ÚÁËÁÚÅ
  $_POST[zid] = $zid;
...
// óäàëåíèå òîâàðîâ èç êîðçèíû // ÕÄÁÌÅÎÉÅ ÔÏ×ÁÒÏ× ÉÚ ËÏÒÚÉÎÙ
  $cart -> clear_cart();

// îòïðàâêà íà e-mail êëèåíòó è îïåðàòîðó // ÏÔÐÒÁ×ËÁ ÎÁ e-mail ËÌÉÅÎÔÕ É ÏÐÅÒÁÔÏÒÕ
